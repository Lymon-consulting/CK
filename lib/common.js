    ...
    selector: function (searchObject, options, aggregation) {
      const selector = this.defaultConfiguration().selector(searchObject, options, aggregation)
        ...
        if (options.search.props.categories) {
          console.log("En commons "+options.search.props.categories);
...
export const ProjectIndex = new Index({
    ...
    engine: new MongoDBEngine({
      ...
      const selector = this.defaultConfiguration().selector(searchObject, options, aggregation)
        ...
        if (options.search.props.project_year) {
          selector.project_year = options.search.props.project_year;
        }
        if (options.search.props.project_role) {
          selector.project_role = options.search.props.project_role;
        }
        return selector;
      }
    }),
