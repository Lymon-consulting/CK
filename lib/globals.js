export let catHeights = [
  ...
  {spec: "1.40 metros – 1.60 metros"},
  {spec: "1.60 metros – 1.80 metros"},
  {spec: "1.80 metros o mas"}
];
...
export let crewOcupations = [
  ...
  },
  {
    category: 'Empresario',
    roles: [
      {roleId:3000,  roleName: 'Dueño de negocio'},
      {roleId:4000, roleName: 'Representante de negocio'}
    ]
  },
  {
    category: 'Fotografía',
