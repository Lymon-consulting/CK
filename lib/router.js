...
FlowRouter.route('/selectProfile', {
   name: 'selectProfile',
      action: function() {
      BlazeLayout.render('mainlayout', {header: 'header', main: 'selectProfile', footer: 'footer'});
   }
});

FlowRouter.route('/confirmProfile/:type', {
   name: 'confirmProfile',
      action: function() {
...
FlowRouter.route('/mediaEditor/:id', {
   name: 'mediaEditor',
...
FlowRouter.route('/editMedia/:id/:type', {
   name: 'editMedia',
      action: function(params, queryParams) {
...
FlowRouter.route('/peopleListCast', {
   name: 'peopleListCast',
      action: function() {
      BlazeLayout.render('mainlayout', {header: 'header', banner:'banner', main: 'peopleListCast', footer: 'footer'});
   }
});
...
FlowRouter.route('/searchCollaboratorForIndustry/:id', {
...
FlowRouter.route('/industryList', {
   name: 'industryList',
      action: function() {
      BlazeLayout.render('mainlayout', {header: 'header', banner:'banner', main: 'industryResults', footer: 'footer'});
   }
});
...
FlowRouter.route('/editIndustry/:id', {
    action: function(params, queryParams) {
        BlazeLayout.render('mainlayout', {header: 'header', banner:'banner', main: 'editIndustry', footer: 'footer', data: params.id});
    }
});
