...
FlowRouter.route('/messages', {
   name: 'messages',
      action: function() {
      BlazeLayout.render('mainlayout', {header: 'header', main: 'messages'});
   }
});
...
FlowRouter.route('/notificationList', {
   ...
   action: function(){
      BlazeLayout.render('mainlayout',{header: 'header', main: 'notificationList',footer:'footer'});
   }
});

FlowRouter.route('/collaborations/:entityType/:entityId', {
   name: 'collaborations',
   action: function(params, queryParams){
      BlazeLayout.render('mainlayout',{header: 'header', main: 'collaborations',footer:'footer'});
   }
});
